  ...
  return (   
      <div className="App">
        ...
        <Routes>
          ...
          <Route path = '/' element={<Home candleData = {candleData} currentCoin={currentCoin} curPattern={curPattern} setCurPattern= {setCurPattern} patternData={patternData} setPatternData={setPatternData} />}/>
        </Routes>
